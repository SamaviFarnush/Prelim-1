using GLPK
#library(glpkAPI)
function calculate_optimal_flux_distribution(stoichiometric_matrix::Array{Float64,2}, default_bounds_array::Array{Float64,2}, species_bounds_array::Array{Float64,2}, objective_coefficient_array::Array{Float64,1}; min_flag::Bool = false)
    ...
    #sensitivity .= GLPK.analyze_bound(lp_problem, 10)
